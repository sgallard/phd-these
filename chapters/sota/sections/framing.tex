...
\secref{sec:sota-retrieval} reviews the first operation, \secref{sec:sota-pagegen} the second, and \secref{sec:sota-reading} the third. The second operation carries the main objective of this thesis (\secref{sec:objectives}) and receives the most extensive treatment. The chapter closes with \secref{sec:sota-synthesis}, which positions the three contribution chapters against the gaps identified along the way.
