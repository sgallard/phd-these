...
\begin{figure}[htbp]
    \centering
    %todo: maybe better remove f_cov from the top and put it below in the format high f_cov (worse), low f_cov (better). Add (a) and (b)
     \includegraphics[width=\widthForTwoImages]{img/problem-formulation/cov.pdf}
...
\begin{figure}[htbp]
    \centering
      \includegraphics[width=\widthForTwoImages]{img/problem-formulation/cap.pdf}
...
\begin{figure}[htbp]
    \centering
    %TODO: Write "main zone" and "main article" , exactly like that
     \includegraphics[width=\widthForTwoImages]{img/problem-formulation/pos.pdf}
...
\begin{figure}[htbp]
    \centering
    %todo legends and markers too small. put (i) (ii) (iii)
     \includegraphics[width=\widthForTwoImages]{img/problem-formulation/va.pdf}
...
\begin{figure}[htbp]
    \centering
    %todo same size for 3 layouts
     \includegraphics[width=\widthForTwoImages]{img/problem-formulation/sty.pdf}
