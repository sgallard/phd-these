...
\begin{figure}[htbp]
    \centering
    %todo CHANGE CAPITALS OF FIGURE
    %todo add a and b to illustrations
...
\begin{figure}[htbp]
    \centering
    %todo change axis. y-axis: number of clusters (bigger). x-axis: Top-N
